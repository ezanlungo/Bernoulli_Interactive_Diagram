...
def factor_friccion(Re, RugRel):
    ...
    if Re>2300 and Re<=4000:
        return print('\n Régimen intermedio o de transición', '\n', 'En régimen Laminar el factor de fricción sería: ', lam(Re), '\n', 'En régimen turbulento el factor de fricción sería: ', turb(Re, RugRel), '\n')
...
if ReTrabajo > 2300 and ReTrabajo <= 4000 :
    print(factor_friccion(ReTrabajo,RugRelTrabajo))
